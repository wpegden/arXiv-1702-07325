...
- [ ] Finish the start-boundary step by proving existence of the actual first boundary edge through `e₁` in the induced subdivision of `[e₁,e₂]`, then remove the remaining existence hypothesis from the unique level-1 successor and start-degree-one wrappers.
