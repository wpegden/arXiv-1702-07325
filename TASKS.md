...
- [ ] Prove `Section5CanonicalBoundarySuccessorData` from actual geometry on the boundary edge `[e₁,e₂]`: construct the unique level-1 successor in the real start component rather than assuming it.
