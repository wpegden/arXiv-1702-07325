...
- [ ] Tie `section5StartNode` to the remaining actual boundary-chain graph data through degree one: identify its unique level-1 successor and show that its degree in the start component is exactly one.
