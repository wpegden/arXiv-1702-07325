...
- [ ] Use the new realization/hull bridge to prove the first genuine perturbation field `Section5PerturbationGenericity.lower_step_exists_of_ne_start` by constructing a lower-face witness at `prefixBarycenter n k` from a non-start Section 5 cell meeting `prefixBarycenterSegment n k`.
